...
public class App23MultiMultiJoin {
    ...
    private static Logger logger = LogManager.getLogger(App23MultiMultiJoin.class);
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        Query query = em.createQuery("select distinct c.id, c.lastname as customer, ca.name as category" +
